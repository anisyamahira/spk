...
<div class="container-fluid mt-4 rounded">
    <form action="/video/create/data" method="POST" class="pt-2 pb-2">
        ...
        <div class="form-group w-50">
            ...
            <input type="text" name="nama_video" class="form-control" placeholder="Masukan Nama Video" required>
        </div>
        <div class="form-group w-50">
            <label>Jumlah Like Video</label>
            <input type="number" name="jum_like" class="form-control" placeholder="Masukan Angka" required>
        </div>
        <div class="form-group w-50">
            <label>Jumlah Play Video</label>
            <input type="number" name="jum_play" class="form-control" placeholder="Masukan Angka" required>
        </div>
        <div class="form-group w-50">
            <label>Jumlah Komentar Video</label>
            <input type="number" name="jum_komentar" class="form-control" placeholder="Masukan Angka" required>
        </div>
        <div class="form-group w-50">
            <label>Jumlah Share Video</label>
            <input type="number" name="jum_share" class="form-control" placeholder="Masukan Angka" required>
        </div>
        <div>
